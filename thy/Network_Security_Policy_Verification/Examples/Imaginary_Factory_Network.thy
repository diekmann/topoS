...
@{term "''Robot1''"} has a security clearance of @{term "1::privacy_level"} and 
@{term "''Robot2''"} has a security clearance of @{term "2::privacy_level"}. 
...
definition "invariants_tuned \<equiv> [BLP_privacy_m, BLP_employee_export_m,
               ...
               new_configured_list_SecurityInvariant SINVAR_LIB_BLPtrusted
                 \<lparr> node_properties = [''MissionControl1'' \<mapsto> \<lparr> privacy_level = 1, trusted = False \<rparr>,
                                      ...
                                      ''Robot1'' \<mapsto> \<lparr> privacy_level = 1, trusted = False \<rparr>,
                                      ''Robot2'' \<mapsto> \<lparr> privacy_level = 2, trusted = False \<rparr>,
