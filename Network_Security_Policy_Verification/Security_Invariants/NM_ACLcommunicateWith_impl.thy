...
by (metis NM_ACLcommunicateWith.sinvar.simps NM_ACLcommunicateWith_impl.sinvar.simps graph.select_convs(1) list_graph_to_graph_def succ_tran_correct)
...
interpretation NM_ACLcommunicateWith_impl:TopoS_List_Impl 
  ...
  and sinvar_spec=NM_ACLcommunicateWith.sinvar
...
section {* packing *}
  ...
  interpretation NM_LIB_ACLcommunicateWith_interpretation: TopoS_modelLibrary NM_LIB_ACLcommunicateWith
      NM_ACLcommunicateWith.sinvar NM_ACLcommunicateWith.verify_globals
