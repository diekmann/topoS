...
imports SINVAR_Sink "../TopoS_Lists_Impl_Interface"
begin
...
interpretation Sink_impl:TopoS_List_Impl 
  ...
  and verify_globals_spec=SINVAR_Sink.verify_globals
...
subsubsection {* Sink packing *}
  definition SINVAR_LIB_Sink :: "('v::vertex, node_config, unit) TopoS_packed" where
  ...
  interpretation SINVAR_LIB_Sink_interpretation: TopoS_modelLibrary SINVAR_LIB_Sink
      SINVAR_Sink.sinvar SINVAR_Sink.verify_globals
