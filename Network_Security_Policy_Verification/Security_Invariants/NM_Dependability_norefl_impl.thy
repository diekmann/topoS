...
lemma[code_unfold]: "SecurityInvariant.node_props NM_Dependability_norefl.default_node_properties P = NetModel_node_props P"
apply(simp add: NetModel_node_props_def)
done

definition "Dependability_norefl_eval G P = (valid_list_graph G \<and> 
  verify_globals G (SecurityInvariant.node_props NM_Dependability_norefl.default_node_properties P) (model_global_properties P) \<and> 
  sinvar G (SecurityInvariant.node_props NM_Dependability_norefl.default_node_properties P))"
...
interpretation Dependability_norefl_impl:TopoS_List_Impl 
  ...
  and receiver_violation=NM_Dependability_norefl.receiver_violation
...
section {* packing *}
  definition NM_LIB_Dependability_norefl :: "('v::vertex, NM_Dependability_norefl.dependability_level, unit) TopoS_packed" where
    ...
    \<lparr> nm_name = ''Dependability_norefl'', 
      nm_receiver_violation = NM_Dependability_norefl.receiver_violation,
