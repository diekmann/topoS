theory NM_Sink_impl
imports NM_Sink NetworkModel_Lists_Impl_Interface FiniteListGraph_Impl
begin
...
apply(rule_tac target_focus=NM_Sink.target_focus in NetworkModel_eval_impl_proofrule)
