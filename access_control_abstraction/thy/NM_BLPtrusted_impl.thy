...
imports NM_BLPtrusted NetworkModel_Lists_Impl_Interface FiniteListGraph_Impl
begin
...
apply(rule_tac target_focus=NM_BLPtrusted.target_focus in NetworkModel_eval_impl_proofrule)
